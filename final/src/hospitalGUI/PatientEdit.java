...
public class PatientEdit extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PatientEdit frame = new PatientEdit();
	...
	public PatientEdit() {
		...
		JButton btnHome_1_1 = new JButton("Delete");
		...
		btnHome_1_1.setFont(new Font("Unispace", Font.BOLD, 13));
		btnHome_1_1.setBounds(635, 107, 139, 39);
		contentPane.add(btnHome_1_1);
	...
	public void loadExisting() {
		...
		try {
			File f1 = new File("selectedrownum");
			FileReader in = new FileReader (f1);
			BufferedReader r = new BufferedReader(in);
			
			int selectedrownum=Integer.parseInt(r.readLine())+1;

			try {
				File f2 = new File("patientinfo"+selectedrownum);
				FileReader in2 = new FileReader (f2);
				BufferedReader r2 = new BufferedReader(in2);
				
				String patientnumber = r2.readLine();
				String firstname = r2.readLine();
				String lastname = r2.readLine();
				String age = r2.readLine();
				String dateofbirth = r2.readLine();
				String mobilenumber = r2.readLine();
				String email = r2.readLine();
				String visitdate = r2.readLine();
				String roomnumber = r2.readLine();
				String pastillnesses = r2.readLine();
				String currentdiagnosis = r2.readLine();
				String symptomreview = r2.readLine();
				String notes = r2.readLine();
				
				patientnumberTF.setText(patientnumber);
				firstnameTF.setText(firstname);
				lastnameTF.setText(lastname);
				ageTF.setText(age);
				dateofbirthTF.setText(dateofbirth);
				mobilenumberTF.setText(mobilenumber);
				emailTF.setText(email);
				visitdateTF.setText(visitdate);
				roomnumberTF.setText(roomnumber);
				pastillnessesTF.setText(pastillnesses);
				currentdiagnosisTF.setText(currentdiagnosis);
				symptomreviewTF.setText(symptomreview);
